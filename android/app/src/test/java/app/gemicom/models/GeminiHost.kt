...
class GeminiHostTest {
    ...
    fun `Test mutating GeminiHost`() {
        ...
        assertEquals("gemini://example.com/page", host.navigate(host.resolve("/page")))
    ...
    fun `Test GeminiHost resolving references`() {
        ...
        assertEquals("gemini://example2.com/image", host.resolve("example2.com/image"))
        assertEquals("gemini://example.com", host.resolve("example.com"))
