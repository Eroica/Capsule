...
Java_earth_groundctrl_capsule_lib_Gemini_parse(
	JNIEnv *env,
	jobject /* this */,
	jstring content
) {
	...
	jclass tokenCls = env->FindClass("earth/groundctrl/capsule/lib/Token");
...
Java_earth_groundctrl_capsule_lib_Gemini_lasterror(JNIEnv *, jclass) {
